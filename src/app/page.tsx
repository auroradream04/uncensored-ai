...
import AuthorPlug from "@/components/globals/AuthorPlug";
...
export default function Home() {
    ...
    const buttonCss =
        "p-1.5 disabled:cursor-not-allowed transition disabled:text-[rgb(130,130,130)] text-white bg-zinc-800 disabled:bg-zinc-900 rounded-md";
                        ...
                        <div className="flex justify-between w-full">
                            <div>
                                ...
                                <CardDescription className="max-w-[300px] text-xs pt-1.5">
                                    A powerful GPT that can answer to any
                                    question without the limits of traditional
                                    AI models
                                </CardDescription>
                            </div>
                            <ThemeToggle />
